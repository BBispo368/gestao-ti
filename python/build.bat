...
..\.venv\Scripts\pyinstaller --noconfirm --onefile --windowed --name "AcessoTI" ^
--add-data "..\.venv\Lib\site-packages\customtkinter;customtkinter/" ^
--icon="app_icon.ico" ^
login_screen.py

echo.
if exist "dist\AcessoTI.exe" (
    echo ============================================================
    echo SUCESSO! O arquivo foi gerado em: python/dist/AcessoTI.exe
    echo ============================================================
) else (
    echo ============================================================
